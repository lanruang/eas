...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>系统登录 - {{config('sysInfo.sysName')}}</title>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="{{asset('resources/views/template/')}}/assets/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="{{asset('resources/views/template/')}}/assets/css/ace-part2.min.css" />
		<![endif]-->
	...
	<body class="login-layout light-login">
				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<i class="ace-icon fa fa-laptop grey"></i>
									<span class="grey">{{config('sysInfo.sysName')}}</span>
								</h1>
							</div>
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form id="loginForm" method="post" action="{{route('login.checkLogin')}}">
												<fieldset>
		...
		<!--[if !IE]> -->
		<script src="{{asset('resources/views/template/')}}/assets/js/jquery.2.1.1.min.js"></script>

		<!-- <![endif]-->

		<!--[if IE]>
<script src="{{asset('resources/views/template/')}}/assets/js/jquery.1.11.1.min.js"></script>
<![endif]-->

		<!--[if !IE]> -->
		<script type="text/javascript">
			window.jQuery || document.write("<script src='{{asset('resources/views/template/')}}/assets/js/jquery.min.js'>"+"<"+"/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='{{asset('resources/views/template/')}}/assets/js/jquery1x.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
		<script type="text/javascript">
