...
@section('breadcrumbNav')
	<li><a href="{{route('department.index')}}">客户列表</a></li>
	<li>添加客户</li>
@endsection()
...
@section('content')
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" id="validation-form" method="post" action="{{route('customer.createCustomer')}}" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" name="customer_num" id="customer_num" placeholder="客户编号"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" name="customer_name" id="customer_name" placeholder="客户名称"/>
					</div>
				</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="customer_phone" id="customer_phone" placeholder="联系电话"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="customer_fax" id="customer_fax" placeholder="传真"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="customer_address" id="customer_address" placeholder="地址"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="customer_website" id="customer_website" placeholder="网址"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="customer_tax_num" id="customer_tax_num" placeholder="税号"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group">
                            <input class="form-control date-picker" id="customer_join_time" name="customer_join_time" type="text"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group">
                            <input class="form-control date-picker" id="customer_end_time" name="customer_end_time" type="text"/>
							 <span class="input-group-addon">
								<i class="fa fa-calendar bigger-110"></i>
							 </span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <textarea class="input-xlarge" name="customer_remark" id="customer_remark"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 客户附件 </label>
                    <div class="col-sm-3">
