...
!function (a) {
    ...
    ace.demo = {
        ...
        var b = a(".sidebar");
        a.fn.ace_sidebar && b.ace_sidebar(), a.fn.ace_sidebar_scroll && b.ace_sidebar_scroll({include_toggle: ace.vars.safari || ace.vars.ios_safari}), a.fn.ace_sidebar_hover && b.ace_sidebar_hover({
            sub_hover_delay: 750,
            ...
            if (!j) {
                ...
                if (g.trigger(o = a.Event("ajaxloadstart"), {
                    ...
                    "POST" == i && "object" == typeof n && (p = a.extend({}, p, n)), a.ajax(p).error(function () {
                        ...
                        }, 10), "function" == typeof h.settings.update_title ? h.settings.update_title.call(null, c, b, p, i, m) : h.settings.update_title === !0 && "GET" == i && f(p), !d && m && a("html,body").animate({scrollTop: 0}, 250), g.trigger("ajaxloadcomplete", {
                            url: b,
                            hash: c,
                            method: i,
                            data: l
    ...
    a.fn.aceAjax = a.fn.ace_ajax = function (d, e, f, g, h) {
        var i, j = this.each(function () {
            var j = a(this), k = j.data("ace_ajax"), l = "object" == typeof d && d;
    ...
    function c(b, c) {
        ...
        var k = "menu-min", l = "responsive-min", m = "responsive-max", n = "h-sidebar", o = function () {
        ...
        o.call(f), a(window).on("resize.sidebar.vars", function () {
            ...
            if (d && 0 != d.length) {
                ...
                if (d.hasClass("dropdown-toggle")) {
                    ...
                    if (!g)return !1;
                    var h = a(g), i = 0, j = g.parentNode.parentNode;
    ...
    a(document).on(ace.click_event + ".ace.menu", ".menu-toggler", function (b) {
        ...
        var g, h = this.each(function () {
            var h = a(this), i = h.data("ace_sidebar"), j = "object" == typeof d && d;
    ...
    function c(b, c) {
        var f, g, h, i, j = this, k = a(window), l = a(b);
        if (f = l.find(".nav-list"), g = f.get(0)) {
            ...
            var n = j.settings.scroll_to_active, o = l.ace_sidebar("ref");
            ...
            var w, x, y = function () {
                ...
                if (!v && j.sidebar_fixed && (f = l.find(".nav-list"), h = l.find(".sidebar-toggle").eq(0), i = l.find(".sidebar-shortcuts").eq(0), g = f.get(0))) {
                    f.wrap('<div class="nav-wrap-up pos-rel" />'), f.after("<div><div></div></div>"), f.wrap('<div class="nav-wrap" />'), j.settings.include_toggle || h.css({"z-index": 1}), j.settings.include_shortcuts || i.css({"z-index": 99}), p = f.parent().next().ace_scroll({
                        size: y(),
                        mouseWheelLock: !0,
                        hoverReset: !1,
                        dragEvent: !0,
                        ...
                        touchDrag: !1
                    }).closest(".ace-scroll").addClass("nav-scroll"), u = p.data("ace_scroll"), q = p.find(".scroll-content").eq(0), r = q.find(" > div").eq(0), t = a(u.get_track()), s = t.find(".scroll-bar").eq(0), j.settings.include_shortcuts && 0 != i.length && (f.parent().prepend(i).wrapInner("<div />"), f = f.parent()), j.settings.include_toggle && 0 != h.length && (f.append(h), f.closest(".nav-wrap").addClass("nav-wrap-t")), f.css({position: "relative"}), 1 == j.settings.scroll_outside && p.addClass("scrollout"), g = f.get(0), g.style.top = 0, q.on("scroll.nav", function () {
            ...
            this.scroll_to_active = function () {
                if (u && u.is_active())try {
                    var a, b = o.vars(), c = l.find(".nav-list");
                ...
                v || A();
                var c = o.vars(), d = !c.collapsible && !c.horizontal && (w = y()) < (x = g.clientHeight);
                this.is_scrolling = !0, d && (r.css({
                    height: x,
                    width: 8
                }), p.prev().css({"max-height": w}), u.update({size: w}), u.enable(), u.reset()), d && u.is_active() ? l.addClass("sidebar-scroll") : this.is_scrolling && this.disable()
            }, this.disable = function () {
                this.is_scrolling = !1, p && (p.css({height: "", "max-height": ""}), r.css({
                    height: "",
                    width: ""
                }), p.prev().css({"max-height": ""}), u.disable()), parseInt(g.style.top) < 0 && j.settings.smooth_scroll && a.support.transition.end ? f.one(a.support.transition.end, function () {
    ...
    function c(b, c) {
        ...
        function k(c) {
            ...
            g && (o = n, m.top += o);
            var t = parseInt(m.top + r), v = 0, y = u.height(), z = parseInt(m.top - k - o), A = y, B = q.horizontal, C = !1;
        ...
        var q = {}, r = ace.vars.old_ie, s = !1, t = l.settings.sub_hover_delay || !1;
        d && t && (l.settings.sub_hover_delay = parseInt(Math.max(l.settings.sub_hover_delay, 2500)));
        var u = a(window), v = a(".navbar").eq(0), w = "fixed" == v.css("position");
        ...
        var y = -1, z = d ? "touchstart.sub_hover" : "mouseenter.sub_hover", A = d ? "touchend.sub_hover touchcancel.sub_hover" : "mouseleave.sub_hover";
        o.on(z, ".nav-list li, .sidebar-shortcuts", function (b) {
            if (q = o.ace_sidebar("vars"), !q.collapsible) {
                var c = a(this), e = !1, g = c.hasClass("hover"), h = c.find("> .submenu").get(0);
    ...
    var d = function (b, d) {
        ...
        this.reload = function () {
            ...
            var b = this.$box, a = "undefined" == typeof a ? 300 : a;
            ...
            var e = this.$box, f = e.find(".widget-body").eq(0), g = null, h = a || (e.hasClass("collapsed") ? "show" : "hide"), i = "show" == h ? "shown" : "hidden";
            ...
            var c = "undefined" == typeof c ? 250 : c, d = "undefined" == typeof d ? 200 : d;
            ...
            var b = this.$box.find("> .widget-header a[data-action=fullscreen]").find(ace.vars[".icon"]).eq(0), d = null, e = null;
            (d = b.attr("data-icon1")) ? e = b.attr("data-icon2") : (d = "fa-expand", e = "fa-compress");
            var f = this.$box.hasClass("fullscreen"), g = a !== !0 && a !== !1;
    ...
    a(document).on("settings.ace", function (b, c, d, e, f) {
        ...
        navbar_fixed: function (b, c, d, e) {
            ...
            var f, c = c || !1, d = "undefined" != typeof d ? d : !0;
            ...
            if (ace.vars.very_old_ie)return !1;
            var c = c || !1, d = "undefined" != typeof d ? d : !0, b = b || "#main-container";
            if ("string" == typeof b && (b = a(b).get(0)), !b)return !1;
            var e;
    ...
    try {
        a("#nav-search-input").bs_typeahead({
            source: ace.vars.US_STATES, updater: function (b) {
                return a("#nav-search-input").focus(), b
            }
        })
    } catch (c) {
    }
    $.fn.scrollUnique = function(type) {
        var type;
            ...
            $(this).on(eventType, function(event) {
                ...
                if(type == 'dataTable'){
                    var scrollTop = this.offsetParent.scrollTop,
                        scrollHeight = this.offsetParent.scrollHeight,
                ...
                if ((delta > 0 && scrollTop <= delta) || (delta < 0 && scrollHeight - height - scrollTop <= -1 * delta)) {
                    ...
                    if(type == 'dataTable'){
                        this.offsetParent.scrollTop = delta > 0? 0: scrollHeight;
                    }else{
