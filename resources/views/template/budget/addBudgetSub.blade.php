    ...
    <script type="text/javascript">
        ...
        $(function ($) {
            ...
            $('#budgetSub tbody').on('click', 'tr td.btn_cp', function () {
                ...
                html = '<div class="col-sm-offset-1 col-sm-5"><div class="dataTables_wrapper form-inline no-footer"><div class="dataTables_scroll"><div class="dataTables_scrollHead" style="overflow: hidden; position: relative; border: 0px; width: 100%;"> <div class="dataTables_scrollHeadInner" style="box-sizing: content-box; width: 100%; padding-right: 20px;"> ' +
                        '<table class="table table-striped table-bordered" style="margin-left: 0px; width: 100%;"> ' +
                        '<thead> ' +
                        '<tr> ' +
                        '<th class="width-50">期间</th> ' +
        ...
        function editBudgetSD(val){
            ...
            var html = '<div class="profile-user-info profile-user-info-striped" style="height: 430px;">';
            ...
            for(var i=0 ; i < number; i++){
                ...
                html += '<div class="profile-info-row">' +
                        ...
                        '<div class="profile-info-value">' +
                        '<div class="col-sm-8">' +
                        '<input type="text" role="budget" name="budget_name" id="budget_name'+i+'" class="form-control text-right" value="'+amount+'" onBlur="formatNum(this);"/>' +
                        '</div></div></div>';
        ...
        function amountSum(){
            var amount = 0;
            var inputLength = $('input[name=budget_name]').length;
            for(var i=0; i<inputLength; i++){
                amount = amount + parseFloat($('#budget_name'+i).val());
            }
        ...
        function aveAmount(e){
            ...
            for(var i=0;i<inputLength;i++){
                $('#budget_name'+i).val(toDecimal(amount));
            }
            amountSum();
        }
