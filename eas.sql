...
CREATE TABLE `audit_info` (
  ...
  `process_user_next` int(10) unsigned NOT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `audit_info` VALUES ('3', 'budget', '4', '编号(345354)—测试预算', '请审核', '4,3,2', '2', '1', '1001', '2017-06-29 16:49:31', '2017-06-29 16:49:31');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `budget` VALUES ('4', '1', '345354', '测试预算', '2017-06', '2017-06', '9', '2017-06-29 16:50:22', '2017-06-29 16:50:22');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `budget_subject` VALUES ('4', '36', '1200.00', '9', '2017-06-29 16:50:32', '2017-06-29 16:50:32'), ('4', '55', '1111.00', '9', '2017-06-29 16:50:34', '2017-06-29 16:50:34');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `budget_subject_date` VALUES ('4', '36', '2017-06', '1200.00', '1200.00', '9', '2017-06-29 16:50:27', '2017-06-29 16:50:27'), ('4', '55', '2017-06', '1111.00', '1111.00', '9', '2017-06-29 16:50:28', '2017-06-29 16:50:28');
COMMIT;
