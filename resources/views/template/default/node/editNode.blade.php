			...
			<form class="form-horizontal" role="form" id="validation-form" method="post" action="{{route('node.updateNode')}}" >
				<div class="form-group">
					...
					<label class="col-sm-2">
						<input type="text" value="{{$ndName}}" id="node_Fname" name="node_Fname" readonly="true" class="form-control" />
					</label>
				...
				<div class="form-group">
					...
					<label class="col-sm-2">
						<input type="text" value="{{$ndAlias}}" name="node_Falias" id="node_Falias" readonly="true" class="form-control" />
					</label>
				</div>
...
@section('pageSpecificPluginScripts')
	...
	<script src="{{asset('resources/views/template').'/'.config('sysInfo.templateName')}}/assets/js/tree.min.js"></script>
@endsection()
