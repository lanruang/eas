...
CREATE TABLE `invoice` (
  ...
  `invo_buy_date` timestamp NULL DEFAULT NULL COMMENT '/*发票购买日期*/',
...
CREATE TABLE `invoice_details` (
  ...
  `invo_status` tinyint(4) DEFAULT NULL COMMENT '/*发票状态*/',
...
INSERT INTO `users` VALUES ('8454859EDC79BCD6B5250DF817FF10EA', '超级管理员', 'admin@sh.net', 'resources/views/template/assets/avatars/user.jpg', '4297f44b13955235245b2497399d7a93', 'A6F7FAF16C', '1', '2018-01-12 13:54:10', '1', '0', '2016-05-25 05:56:33', '2018-01-12 13:54:10');
