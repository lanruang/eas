...
@section('content')
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" role="form" id="validation-form" method="post" action="{{route('subjects.updateSubjects')}}" >
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"> 上级科目名称 </label>
					<label class="col-sm-2">
						<input type="text"  id="subject_Fname" name="subject_Fname" readonly="true" class="form-control" value="{{ $subject_Fname }}" />
					</label>
				...
				<div class="form-group">
					...
					<label class="col-sm-2">
						<input type="text" name="subject_Fip" id="subject_Fip" readonly="true" class="form-control" value="{{ $subject_Fip }}" />
					</label>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="subject_name" id="subject_name" placeholder="科目名称" class="form-control" value="{{ $sub_name }}" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="subject_ip" id="subject_ip" placeholder="科目地址" class="form-control" value="{{ $sub_ip }}" />
					</div>
				</div>
					...
					<div class="col-sm-3">
						<label>
							<select class="form-control" id="subject_type" name="subject_type">
								...
								<option value="1" @if ( $sub_type == '1') selected="selected" @endif>借</option>
								<option value="-1" @if ( $sub_type == '-1') selected="selected" @endif>贷</option>
							</select>
						</label>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-3 output">
						<label>
							<input name="subject_budget" id="subject_budget" class="ace ace-switch ace-switch-6" type="checkbox" @if ( $sub_budget == '1') checked="checked" @endif>
							<span class="lbl"></span>
						</label>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-3 output">
						<label>
							<input name="subject_status" id="subject_status" class="ace ace-switch ace-switch-6" type="checkbox" @if ( $status == '1') checked="checked" @endif>
							<span class="lbl"></span>
						</label>
					</div>
				</div>
				...
				{{csrf_field()}}
				<input type="hidden" name="subject_pid" id="subject_pid" value="{{ $sub_pid }}">
