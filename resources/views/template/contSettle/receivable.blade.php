		...
		<div class="col-xs-12 col-sm-12">
			<div class="clearfix">
				<div class="grid2 new_grid2">
					<button type="button" class="btn btn-white btn-sm btn-round" onclick="createReceivable();">生成应收款</button>
				</div>
			</div>
			<p></p>
...
@section('FooterJs')
	<script type="text/javascript">
			...
			contractTable = $('#contractTable')
					.DataTable({
						...
						"ajax": {
							...
							"async": false,
							"dataType": "json",
							"url": '{{route('contSettle.getReceivable')}}',
		...
		function createReceivable(){
			window.location.href = "{{route('contSettle.createReceivable')}}";
		}
