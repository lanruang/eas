		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" id="validation-form" method="post" action="{{route('supplier.createSupplier')}}" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" name="supplier_num" id="supplier_num" placeholder="供应商编号"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" name="supplier_name" id="supplier_name" placeholder="供应商名称"/>
					</div>
				</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="supplier_phone" id="supplier_phone" placeholder="联系电话"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="supplier_fax" id="supplier_fax" placeholder="传真"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="supplier_address" id="supplier_address" placeholder="地址"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="supplier_website" id="supplier_website" placeholder="网址"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="supplier_tax_num" id="supplier_tax_num" placeholder="税号"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group">
                            <input class="form-control date-picker" id="supplier_join_time" name="supplier_join_time" type="text"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group">
                            <input class="form-control date-picker" id="supplier_end_time" name="supplier_end_time" type="text"/>
							 <span class="input-group-addon">
								<i class="fa fa-calendar bigger-110"></i>
							 </span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <textarea class="input-xlarge" name="supplier_remark" id="supplier_remark"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right"> 供应商附件 </label>
                    <div class="col-sm-3">
