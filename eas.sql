...
INSERT INTO `audit_info` VALUES ('6', 'reimburse', '20', '单据号：R2017080210153067533', '123', '1,1,1', '|1|,|1|,|1|', '0', '1', '1001', '2017-08-04 15:48:16', '2017-08-08 10:39:02');
...
INSERT INTO `audit_info_text` VALUES ('101', '6', '1', '123123', '1', '1002', '2017-08-07 13:48:46', '2017-08-07 13:48:46');
INSERT INTO `audit_info_text` VALUES ('102', '6', '1', '', '2', '1002', '2017-08-07 15:12:00', '2017-08-07 15:12:00');
INSERT INTO `audit_info_text` VALUES ('103', '6', '1', '', '3', '1002', '2017-08-08 10:39:02', '2017-08-08 10:39:02');
...
INSERT INTO `audit_process` VALUES ('3', '1', 'reimburse', 'test', '2,4', '1', '2017-08-03 11:46:13', '2017-08-03 11:46:13');
...
INSERT INTO `budget` VALUES ('20', '', 'day', '0', '1', '132312', '32132312', '2017-07-28', '2017-07-28', '102', null, null);
...
-- ----------------------------
INSERT INTO `department` VALUES ('1', '总经办', '1', '0', '0', '1', '1', '0', '2017-06-02 07:01:15', null);
INSERT INTO `department` VALUES ('2', 'IT部', '3', '1', '0', '2', '1', '0', '2017-06-07 03:42:57', null);
INSERT INTO `department` VALUES ('3', '销售部', '4', '1', '0', '2', '1', '0', '2017-06-07 03:45:21', null);
...
-- Records of expense
-- ----------------------------
INSERT INTO `expense` VALUES ('20', 'reimburse', '1', '1', 'R2017080210153067533', '', '2017-08-02', '0', '0.00', '205', '2017-08-09 14:29:23', '2017-08-09 14:29:23');
...
CREATE TABLE `expense_enclosure` (
  `enclo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `expense_id` int(10) NOT NULL,
  `exp_id` int(10) NOT NULL,
  `enclo_type` varchar(255) DEFAULT NULL,
  `enclo_user` int(10) NOT NULL,
  `enclo_url` text,
  `created_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
-- ----------------------------
INSERT INTO `expense_enclosure` VALUES ('13', '20', '19', 'reimburse', '1', 'uploads/reimburse/20/2017-08-02-10-15-54-598135da055f5.jpg', '2017-08-02 10:15:55', '2017-08-02 10:15:55');
INSERT INTO `expense_enclosure` VALUES ('14', '20', '20', 'reimburse', '1', 'uploads/reimburse/20/2017-08-02-10-16-00-598135e064ebb.jpg', '2017-08-02 10:16:07', '2017-08-02 10:16:07');
INSERT INTO `expense_enclosure` VALUES ('16', '20', '28', 'reimburse', '1', 'uploads/reimburse/20/2017-08-02-17-04-30-5981959e04c58.jpg', '2017-08-02 17:04:47', '2017-08-02 17:04:47');
...
CREATE TABLE `expense_main` (
  ...
  `exp_remark` varchar(255) NOT NULL,
  `subject_id_debit` int(10) NOT NULL,
  `subject_id_credit` int(10) NOT NULL,
  `exp_amount` decimal(10,2) NOT NULL,
  `exp_user` int(10) NOT NULL,
...
-- ----------------------------
INSERT INTO `expense_main` VALUES ('19', '20', '111', '0', '0', '99999999.99', '1', '1', '2017-08-02 10:15:55', '2017-08-02 10:15:55');
INSERT INTO `expense_main` VALUES ('20', '20', '2342342', '0', '0', '3244324.00', '1', '1', '2017-08-02 10:16:07', '2017-08-02 10:16:07');
INSERT INTO `expense_main` VALUES ('23', '20', '123123', '0', '0', '123123.00', '1', '0', '2017-08-02 10:19:13', '2017-08-02 10:19:13');
INSERT INTO `expense_main` VALUES ('24', '20', '123123', '0', '0', '123123.00', '1', '0', '2017-08-02 10:19:30', '2017-08-02 10:19:30');
INSERT INTO `expense_main` VALUES ('28', '20', '1111', '0', '0', '111.00', '1', '1', '2017-08-02 17:04:47', '2017-08-02 17:04:47');
...
-- Records of node
-- ----------------------------
INSERT INTO `node` VALUES ('1', '0', '主页', 'main.index', '1', 'fa fa-home', '1', '0', '1', '0', '', '', '2016-08-31 15:02:05', '2017-08-04 14:52:02');
...
INSERT INTO `node` VALUES ('54', '39', '流程审核', 'auditMy.index', '2', 'fa fa-caret-right', '1', '1', '1', '0', '', '', '2017-07-02 17:50:14', '2017-08-07 15:14:25');
...
INSERT INTO `node` VALUES ('57', '2', '系统组件-页面跳转', 'component.ctRedirectMsg', '1', 'fa fa-caret-right', '0', '0', '1', '0', '', '', '2017-08-04 14:45:44', '2017-08-04 14:45:44');
INSERT INTO `node` VALUES ('58', '39', '消息通知', 'notice.index', '1', 'fa fa-caret-right', '1', '1', '1', '0', '', '', '2017-08-07 15:15:18', '2017-08-07 15:15:18');
...
CREATE TABLE `notice` (
  ...
  `notice_class` varchar(255) NOT NULL,
  `notice_type` tinyint(1) NOT NULL,
  `notice_app` int(10) unsigned NOT NULL,
  `notice_message` text NOT NULL,
  `notice_remark` text NOT NULL,
  `notice_user` int(10) NOT NULL,
  `post_user` int(10) NOT NULL,
  `notice_value` varchar(255) DEFAULT NULL,
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES ('1', 'reimburse', '1', '20', '报销单据：编号R2017080210153067533。', '', '1', '0', '1', '1', '1', '2017-08-09 16:32:51', '2017-08-09 16:32:51');
INSERT INTO `notice` VALUES ('107', 'reimburse', '1', '20', '报销单据：编号R2017080210153067533。已付款，请确认收款。', '', '1', '1', '1', '1', '1', '2017-08-09 16:27:09', '2017-08-09 16:27:09');
INSERT INTO `notice` VALUES ('108', 'reimburse', '0', '20', '报销单据：编号R2017080210153067533。确认收款。', '', '7', '1', null, '0', '0', '2017-08-09 16:12:59', '2017-08-09 16:12:59');
...
INSERT INTO `positions` VALUES ('7', '出纳员', '1', '1', '1', '0', null, null);
...
INSERT INTO `subjects` VALUES ('4', '0', '6000', '损益', '0', '1', '0', '0', '2017-08-03 16:44:38', '2017-08-03 16:44:38');
...
CREATE TABLE `sys_config` (
  ...
  `sys_class` varchar(10) NOT NULL,
  `sys_type` varchar(255) NOT NULL,
...
-- ----------------------------
INSERT INTO `sys_config` VALUES ('1', 'budget', 'subBudget', '4', '预算科目ID');
INSERT INTO `sys_config` VALUES ('2', 'reimburse', 'userCashier', '7', '费用报销核销出纳id');
...
INSERT INTO `sys_status` VALUES ('14', '205', '费用报销', '拒绝付款', '<span style=\"color:red;\">拒绝付款</span>');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', '超级管理员', 'admin@sh.net', 'resources/views/template/assets/avatars/user.jpg', '4297f44b13955235245b2497399d7a93', '5', '1', '2017-08-09 11:09:05', '1', '0', '2016-05-25 05:56:33', '2017-08-09 11:09:05');
...
INSERT INTO `users` VALUES ('5', 'Php工程师user', 'test@2.net', 'resources/views/template/assets/avatars/user.jpg', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '2017-08-04 14:52:21', '1', '0', '2017-06-07 03:46:27', '2017-08-04 14:52:21');
