!function (a) {
    ...
    var b = a.fn.tree, c = function (b, c) {
    ...
    c.prototype = {
        constructor: c, destroy: function () {
            ...
            var c = this, d = b.hasClass("tree") ? b : b.parent(), e = d.find(".tree-loader:eq(0)"), f = d.data();
            ...
            if (0 != this.options.selectable) {
                var c = a(b), d = c.data(), e = this.$element.find(".tree-selected"), f = [], g = c.find(".icon-item");
            ...
            var c = a(b), d = c.closest(".tree-branch"), e = this.$element.find(".tree-branch.tree-selected"), f = d.data(), g = [], h = "selected";
            ...
            this.$element.find("." + a.trim(this.options["open-icon"].replace(/(\s+)/g, "."))).each(function () {
                var c = a(this).removeClass(this.options["open-icon"] + " " + this.options["close-icon"]).addClass(this.options["close-icon"]), d = c.parent().parent(), e = d.children(".tree-branch-children");
                e.addClass("hide"), b || e.empty()
            })
        }
    }, a.fn.tree = function (b) {
        var d, e = Array.prototype.slice.call(arguments, 1), f = this.each(function () {
            var f = a(this), g = f.data("fu.tree"), h = "object" == typeof b && b;
            g || f.data("fu.tree", g = new c(this, h)), "string" == typeof b && (d = g[b].apply(g, e))
        });
        return void 0 === d ? f : d
    }, a.fn.tree.defaults = {
        dataSource: function () {
        }, multiSelect: !1, cacheItems: !0, folderSelect: !1
