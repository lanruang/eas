...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="{{asset('resources/views/template/').'/'.config('sysInfo.templateName')}}/assets/css/ace.min.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="{{asset('resources/views/template/').'/'.config('sysInfo.templateName')}}/assets/css/ace-part2.min.css" />
		<![endif]-->
