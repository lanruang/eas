		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" id="validation-form" method="post" action="{{route('customer.createCustomer')}}" >
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" class="form-control" name="cust_num" id="cust_num" placeholder="客户编号"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" name="cust_name" id="cust_name" placeholder="客户名称"/>
					</div>
				</div>
