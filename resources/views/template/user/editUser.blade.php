								...
								<div class="col-xs-12 col-sm-9">
									<div class="profile-user-info profile-user-info-striped">
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value form-group">
												<label class="col-xs-3">
													<input type="text" name="user_name" id="user_name" placeholder="姓名" class="form-control" value="{{ $user->user_name }}"/>
												</label>
											</div>
										</div>
										<div class="profile-info-row">
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value form-group">
												<label class="col-xs-3 output" id="dep_list">{{ $user->dep_name }}</label>
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value form-group">
												<label class="col-xs-3 output" id="pos_list">{{ $user->pos_name }}</label>
												<input type="hidden" name="positions" id="positions" value="{{ $user->positions }}"/>
											...
											<div class="profile-info-value">
												<label class="col-xs-3">
													<select name="role_id" class="form-control" id="role_id">
														...
														@foreach ($role as $v)
															<option value="{{ $v->id }}" @if ( $v->id == $user->role_id) selected="selected" @endif>{{ $v->name }}</option>
														@endforeach
													</select>
												</label>
											</div>
											...
											<div class="profile-info-value">
												<label class="col-xs-3">
													<select name="status" class="form-control" id="status">
														<option value="0" @if ( $user->status == '0') selected="selected" @endif>否</option>
